...
{
	print("PyProgress2 Loaded.");
	return 1;
}

forward CreatePlayerProgressBar_py(playerid, Float:x, Float:y, Float:width, Float:height, colour, Float:max, direction);
public CreatePlayerProgressBar_py(playerid, Float:x, Float:y, Float:width, Float:height, colour, Float:max, direction)
{
